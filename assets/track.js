...
PostAffRequest.prototype.fillTrackingParams=function(){var params=this.getTrackingParams();var visitorId=PostAffTrackingRequest.getGetParams().getParamValue('visitorId');if(visitorId!==undefined){this.cookieManager.setVisitorId(visitorId);}else{visitorId=this.cookieManager.getVisitorId();}
if(visitorId!=null&&visitorId!='null'){params.addParam('visitorId',visitorId);}
